...
def add_contextual_raise_lookups(font, rules, ison_indicator_names):
    if not rules:
        return
...
def update_font(path):
    ...
    add_contextual_raise_lookups(font, rules, ison_indicator_names)
