...
character + koronis + gorgon-family or fthora/chroa mark." See
[Contextual Mark Positioning](contextual-positioning.md) for the production
GPOS rules that use this order to avoid above-mark collisions.
